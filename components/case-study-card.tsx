        ...
        <div className="space-y-4">
          ...
          {resource && (
            <button
              ...
              className="inline-flex items-center justify-center gap-2 text-sm border-2 border-primary-accent text-primary-accent hover:bg-primary-accent hover:text-dark-primary transition-colors rounded-full px-4 py-2 font-medium w-full sm:w-auto"
            >
              View Details
            </button>
          )}
